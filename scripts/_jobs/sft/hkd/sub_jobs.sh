...
qsub sft_llama_sml_mask_train_job.sh
qsub sft_llama_sml_ent_id_train_job.sh
# qsub sft_llama_core_train_job.sh
# qsub sft_qwen2.5_sml_train_job.sh
# qsub sft_qwen2.5_core_train_job.sh
# qsub sft_olmo_sml_train_job.sh
# qsub sft_olmo_core_train_job.sh
