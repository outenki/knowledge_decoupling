...
/bin/bash $SCRIPT_PATH/sft.sh \
   ...
   $PROJECT_BASE_PATH/output/gpt2/smolLM2/smolLM2_bs1024_dl0_ep1-ext_test_mix_ep3-sft_squad_train_val_ans_ep3 \
   3
...
/bin/bash $SCRIPT_PATH/sft.sh \
   ...
   $PROJECT_BASE_PATH/output/gpt2/smolLM2/smolLM2_bs1024_dl0_ep1-ext_test_mix_ep3-sft_squad_test_ans_ep3 \
   3