...
def read_args():
    ...
    parser.add_argument('--ent-generator', dest='ent_generator', choices={"ENT", "ENT_ID","NE", "ID", "RANDOM"}) 
    parser.add_argument('--unk-generator', dest='unk_generator', choices={"UNK", "UNK_ID", "UNK-TAG", "ID", "RANDOM"}) 
