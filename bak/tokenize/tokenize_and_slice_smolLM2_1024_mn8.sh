...
DATA_PATH=$PROJECT_BASE_PATH/data/SmolLM2-1.7B-100B/sents/mn_8/nonce-parts
OUTPUT_PATH=$PROJECT_BASE_PATH/data/SmolLM2-1.7B-100B/sents/mn_8/tokenized-nonce/
ITER_NUM=10
SIZE=1000000
TOKENIZER=$1
